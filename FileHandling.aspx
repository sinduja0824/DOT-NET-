<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileHandling.aspx.cs" Inherits="FileHandling" %>
...
<asp:Button ID="btnRead" runat="server" Text="Read from File" OnClick="btnRead_Click" />
